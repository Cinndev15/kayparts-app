...
import {
  ...
  FileText, Edit2, Info, CheckCircle2, XCircle, Trash2
} from 'lucide-react';
...
const Articles = ({ user, onLogout }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!title.trim() || !category.trim()) {
      showAlert('El título y la categoría son campos obligatorios.', 'error');
      return;
    }
    ...
    // We use POST with _method=PUT for updates if we upload a file, or standard PUT/POST
    ...
    try {
      const response = await fetch(url, {
        method: 'POST', // Use POST method to allow file upload with _method=PUT
        headers: {
          'Authorization': `Bearer ${token}`,
          'Accept': 'application/json'
        },
      ...
      showAlert(`Artículo ${isEdit ? 'actualizado' : 'creado'} correctamente.`, 'success');
      cancelEdit();
      fetchArticles();
          ...
          <div className="card" style={{
            ...
            <div>
              <h2 className="title-font" style={{
                ...
                {editingArticle ? 'Editar Artículo' : 'Publicar Artículo'}
              </h2>
              <p style={{ fontSize: '13px', color: '#64748b' }}>
                {editingArticle ? 'Modifique los campos correspondientes.' : 'Ingrese la información básica del artículo informativo.'}
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
              ...
              <div className="input-group">
                ...
                <input
                  type="text"
                  placeholder="Ej. Mecánica, Consejos, Noticias"
                  value={category}
              ...
              <div className="input-group">
                ...
                <span style={{ fontSize: '11px', color: '#94a3b8', marginTop: '4px', display: 'block' }}>
                  Suba una foto descriptiva para la portada de la noticia.
                </span>
              </div>
              ...
              <div className="input-group">
                ...
                <textarea
                  ...
                  style={{ width: '100%', padding: '10px 12px', borderRadius: '6px', border: '1px solid #cbd5e1', fontSize: '13px', color: '#0f172a', outline: 'none', minHeight: '180px', fontFamily: 'inherit' }}
                  required
                />
              </div>
